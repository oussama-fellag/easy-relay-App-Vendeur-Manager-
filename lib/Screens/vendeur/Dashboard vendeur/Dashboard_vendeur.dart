      ...
      SizedBox(height: 15,),
          ...
          Expanded(
            child: DataTable2(
                ...
                columns:const [
              DataColumn(
                label: Text("ID cmd", style: TextStyle(fontWeight: FontWeight.bold,fontSize: 15,color: kPrimaryColor),)),
              DataColumn(
                  label: Text("Vendeur", style: TextStyle(fontWeight: FontWeight.bold,fontSize: 15,color: kPrimaryColor),)),
              DataColumn(
                  label: Text("Type", style: TextStyle(fontWeight: FontWeight.bold,fontSize: 15,color: kPrimaryColor),)),
                  DataColumn(
                      label: Text("Client", style: TextStyle(fontWeight: FontWeight.bold,fontSize: 15,color: kPrimaryColor),)),
                  DataColumn(
                      label: Text("prix", style: TextStyle(fontWeight: FontWeight.bold,fontSize: 15,color: kPrimaryColor),)),
                  DataColumn(
                      label: Text("Wilaya", style: TextStyle(fontWeight: FontWeight.bold,fontSize: 15,color: kPrimaryColor),)),
